...
<?php
    foreach ($modules['new'] as $m) {
        ...
        if (isset($mInfo) && is_object($mInfo) && ($module->code == $mInfo->code)) {
            ...
            echo '<a href="' . tep_href_link('modules_content.php', 'action=list_new&module=' . $module->code) . '">' . tep_image(DIR_WS_IMAGES . 'icon_info.gif', IMAGE_ICON_INFO) . '</a>';
        } ?>&nbsp;</td>
              </tr>
<?php
    } ?>
...
<?php
    foreach ($modules['installed'] as $m) {
        ...
        if (isset($mInfo) && is_object($mInfo) && ($module->code == $mInfo->code)) {
            ...
            echo '<a href="' . tep_href_link('modules_content.php', 'module=' . $module->code) . '">' . tep_image(DIR_WS_IMAGES . 'icon_info.gif', IMAGE_ICON_INFO) . '</a>';
        } ?>&nbsp;</td>
              </tr>
<?php
    } ?>
