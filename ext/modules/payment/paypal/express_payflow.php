    ...
    case 'retrieve':
      ...
      if ($response_array['RESULT'] == '0') {
          ...
          if (!tep_session_is_registered('ppeuk_token')) {
              tep_session_register('ppeuk_token');
          }
          $ppeuk_token = $response_array['TOKEN'];

          if (!tep_session_is_registered('ppeuk_payerid')) {
              tep_session_register('ppeuk_payerid');
          }
          $ppeuk_payerid = $response_array['PAYERID'];

          if (!tep_session_is_registered('ppeuk_payerstatus')) {
              tep_session_register('ppeuk_payerstatus');
          }
          $ppeuk_payerstatus = $response_array['PAYERSTATUS'];

          if (!tep_session_is_registered('ppeuk_addressstatus')) {
              tep_session_register('ppeuk_addressstatus');
          }
