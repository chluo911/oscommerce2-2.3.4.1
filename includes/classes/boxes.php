...
*/
  ...
  class tableBox
  {
      ...
      // class constructor
      public function tableBox($contents, $direct_output = false)
      {
  ...
  {
      public function infoBox($contents)
      {
  ...
  {
      public function infoBoxHeading($contents, $left_corner = true, $right_corner = true, $right_arrow = false)
      {
  ...
  {
      public function contentBox($contents)
      {
          $info_box_contents = array();
  ...
  {
      public function contentBoxHeading($contents)
      {
  ...
  {
      public function errorBox($contents)
      {
  ...
  {
      public function productListingBox($contents)
      {
