...
*/
  ...
  class paypal_pro_payflow_ec
  {
      ...
      public function paypal_pro_payflow_ec()
      {
      ...
      public function pre_confirmation_check()
      {
          ...
          if (!tep_session_is_registered('ppeuk_order_total_check')) {
              tep_session_register('ppeuk_order_total_check');
          }
      ...
      public function setExpressCheckout($parameters)
      {
      ...
      public function doExpressCheckoutPayment($parameters)
      {
          if (MODULE_PAYMENT_PAYPAL_PRO_PAYFLOW_EC_TRANSACTION_SERVER == 'Live') {
              $api_url = 'https://payflowpro.paypal.com';
          } else {
